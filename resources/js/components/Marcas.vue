  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <!-- fim card de listagem marcas -->
      </div>
    </div>

    <!-- modal de inclusao de marca -->
    ...
    <!-- modal de visualizacao de marca-->
    ...
    <!-- fim do modal de visualizacao de marca -->
    ...
    <!-- fim modal atualizacao de marca -->
  </div>
</template>
...
export default {
  data() {
    return {
      ...
      urlFiltro: "",
      nomeMarca: "",
      arquivoImagem: [], //em caso de input tipo file devemos usar array e fazer onchange para pegar o valor ao inves de v-model
      transacaoStatus: "",
      transacaoDetalhes: {},
      marcas: { data: {} },
      busca: { id: "", nome: "" },
  ...
  methods: {
    ...
    paginacao(l) {
      if (l.url) {
        ...
        this.carregarLista(); //requisitando novamente os dados para nossa API com base na url atualizada
      }
    },
    carregarLista() {
